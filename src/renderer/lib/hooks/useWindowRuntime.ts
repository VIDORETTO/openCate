// =============================================================================
// useWindowRuntime — the shared "app shell runtime" every openCate window mounts.
//
...
// title sync, "Open With openCate", dock-back receiver, perf/E2E) stays in App.tsx's
