...
import {
  ...
  AGENT_SESSION_HISTORY_LIST,
  AGENT_SESSION_HISTORY_LOAD,
...
const invokeForwarders = {
  ...
  agentSessionHistoryList: makeInvoker<'agentSessionHistoryList'>(AGENT_SESSION_HISTORY_LIST),
  agentSessionHistoryLoad: makeInvoker<'agentSessionHistoryLoad'>(AGENT_SESSION_HISTORY_LOAD),
