...
export interface AgentHooksCapability {
   ...
   *  entries openCate previously wrote.
   ...
   *  folder is already in the repo (the 'auto' signal), and whether openCate has
...
const BRIDGE_JS = `// Generated by the openCate runtime daemon (agent hook injection). Do not edit.
'use strict'
